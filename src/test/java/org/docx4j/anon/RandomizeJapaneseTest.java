...
public class RandomizeJapaneseTest {
	...
	public static void main(String[] args) throws Docx4JException, JAXBException {
		...
		if (save) {
			wordMLPackage.save(new File(System.getProperty("user.dir") + "/Japanese_IN.docx"));
		} 
		
        Anonymize anon = new Anonymize(wordMLPackage);
        anon.go();
        
        Docx4J.save(wordMLPackage, new  File(System.getProperty("user.dir") + "/Japanese_OUT.docx"));
		
	}	

	
	static String documentXML ="<w:document mc:Ignorable=\"w14 wp14\" xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\" xmlns:xml=\"http://www.w3.org/XML/1998/namespace\" xmlns:mc=\"http://schemas.openxmlformats.org/markup-compatibility/2006\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\">"
            + "<w:body>"
	...
	static String themeXML = "<a:theme name=\"Office ​​テーマ\" xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\">"
            + "<a:themeElements>"
