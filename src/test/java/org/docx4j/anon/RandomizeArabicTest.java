...
public class RandomizeArabicTest {
	...
	public static void main(String[] args) throws Docx4JException, JAXBException {
		...
		if (save) {
			wordMLPackage.save(new File(System.getProperty("user.dir") + "/Arabic_IN.docx"));
		} 
		
        Anonymize anon = new Anonymize(wordMLPackage);
        anon.go();
        
        Docx4J.save(wordMLPackage, new  File(System.getProperty("user.dir") + "/Arabic_OUT.docx"));
		
	}	
	
	static String documentXML = "<w:document xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\">"
            + "<w:body>"
	...
	static String themeXML = "<a:theme name=\"Office ??\" xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\" xmlns:thm15=\"http://schemas.microsoft.com/office/thememl/2012/main\">"
            + "<a:themeElements>"
