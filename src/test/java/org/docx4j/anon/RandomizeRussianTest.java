...
public class RandomizeRussianTest {
	...
	public static void main(String[] args) throws Docx4JException, JAXBException {
		...
		if (save) {
			wordMLPackage.save(new File(System.getProperty("user.dir") + "/Russian_IN.docx"));
		} 
		
        Anonymize anon = new Anonymize(wordMLPackage);
        anon.go();
        
        Docx4J.save(wordMLPackage, new  File(System.getProperty("user.dir") + "/Russian_OUT.docx"));
	...
	static String themeXML = "<a:theme name=\"Office Theme\" xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\">"
            + "<a:themeElements>"
